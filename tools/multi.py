...
def n_fireSimple():
	subprocess.Popen(["c:/apache24/bin/ab.exe", "-n","10000","-c","64","http://192.168.0.10:3000/simpleString/",">","n_simple.txt"], shell=True, stdin=None, stdout=None, stderr=None, close_fds=True)
...
def p_fireSimple():
	subprocess.Popen(["c:/apache24/bin/ab.exe", "-n","10000","-c","64","http://192.168.0.10/simpleString.php",">","p_simple.txt"], shell=True, stdin=None, stdout=None, stderr=None, close_fds=True)
