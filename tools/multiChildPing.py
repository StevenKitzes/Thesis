...
def n_fireRegexp():
	subprocess.Popen(["c:/apache24/bin/ab.exe", "-n","30","-c","1","http://192.168.0.10:3000/regexpChildPing/",">","../results/n_regexp" + mod + ".txt"], shell=True, stdin=None, stdout=None, stderr=None, close_fds=True)
...
def p_fireRegexp():
	subprocess.Popen(["c:/apache24/bin/ab.exe", "-n","30","-c","1","http://192.168.0.10/regexpChildPing.php",">","../results/p_regexp" + mod + ".txt"], shell=True, stdin=None, stdout=None, stderr=None, close_fds=True)
